...
switch (strtolower($customer_type)) {
    case 'r':
        if($invoice_subtotal < 100) {$discount_percent = .0;}
        else if($invoice_subtotal >= 100 && $invoice_subtotal < 250) {$discount_percent = .1;}
        else if($invoice_subtotal >= 250 && $invoice_subtotal < 500) {$discount_percent = .25;}
        else {$discount_percent = .3;}
        break;
    ...
    case 't':
        if($invoice_subtotal < 500) {$discount_percent = .4;}
